...
public class NQueensProblem {
	...
	//TODO memoize triples (v0, v1, v2) generated by these loops:
	//- generate them once for v0 = (n,n) on an (n+1)^2 chessboard,
	//- translate and crop them for each actual v0 on the n^2 board,
	//- perhaps the cropping could be done efficiently using two bitmaps.
        for (int lineStep = -maxStep; lineStep <= maxStep; lineStep++) {
            int line1 = line + lineStep;
            if (lineStep != 0 && isValid(line1 + lineStep)) {
                for (int columnStep = -maxStep; columnStep <= maxStep; columnStep++) {
